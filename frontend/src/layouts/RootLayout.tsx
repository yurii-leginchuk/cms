...
import { Globe, LayoutDashboard, LayoutList, Tag, Settings, BookOpen, MessageSquare, BarChart2, FileText, BotMessageSquare, Gauge, FileEdit, TrendingUp, Files, Braces, Image as ImageIcon, Shield } from 'lucide-react'
